...
class SrtFormatter implements SubtitleFormatterInterface
{
    public function format($index, $caption, DateTime $started_at, $default_duration)
    {
        ...
        return sprintf($content_format, $index, $current_time_diff->format('%H:%I:%S,000'), $final_time_diff->format('%H:%I:%S,000'), $caption);
    }
}